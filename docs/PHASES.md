# Naqsh — implementation notes, phase by phase

These are the detailed engineering notes for each phase of Naqsh's
construction: what was built, why it was built that way, and which
alternatives were rejected. They were split out of the README, which had
grown past 3,000 lines and buried the things a first-time reader actually
needs.

Nothing here is required to run or evaluate Naqsh — see
[JUDGES.md](../JUDGES.md) for that. This is the reference for anyone
reading the source and wondering "why is it like this?".
